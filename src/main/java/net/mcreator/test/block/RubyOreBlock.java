...
import net.mcreator.test.item.RubyItem;
...
public class RubyOreBlock extends TestModElements.ModElement {
	@ObjectHolder("test:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(TestModElements instance) {
		super(instance, 10);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("test:ruby_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("test:ruby_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
