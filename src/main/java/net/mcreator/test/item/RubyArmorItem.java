...
public class RubyArmorItem extends TestModElements.ModElement {
	@ObjectHolder("test:ruby_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("test:ruby_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("test:ruby_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("test:ruby_armor_boots")
	public static final Item boots = null;
	public RubyArmorItem(TestModElements instance) {
		super(instance, 3);
	}
		...
		elements.items
				.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT).isImmuneToFire()) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "test:textures/models/armor/ruby_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
					}
