...
import net.mcreator.test.procedures.KeyBindCOnKeyPressedProcedure;
...
public class KeyBindCKeyBinding extends TestModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public KeyBindCKeyBinding(TestModElements instance) {
		super(instance, 32);
	...
	public void initElements() {
		keys = new KeyBinding("key.test.key_bind_c", GLFW.GLFW_KEY_C, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				KeyBindCOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
